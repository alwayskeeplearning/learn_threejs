...
// 创建颜色关键帧动画
const colorKeyframeTrack = new THREE.ColorKeyframeTrack('cube.material.color', [0, 2, 4], [1, 0, 1, 1, 1, 0, 1, 0, 1]);

// 创建动画混合器
mixer = new THREE.AnimationMixer(mesh);
// 创建动画剪辑
const clip = new THREE.AnimationClip('move', 4, [positionKeyframeTrack, rotationKeyframeTrack, colorKeyframeTrack]);
// 创建动画动作
